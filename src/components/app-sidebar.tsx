...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  ...
  return (
    <Sidebar
      collapsible="icon"
      variant="inset"
      className="bg-slate-800 border-slate-600 transition-all duration-300 ease-in-out"
      {...props}
    >
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton
              size="lg"
              asChild
              className="hover:bg-slate-700/50 data-[state=open]:bg-slate-700/70 data-[state=open]:hover:bg-slate-700/80"
            >
      ...
      <SidebarFooter className="bg-slate-800 border-t border-slate-600/50">
